export default {
  ...
  'page.title.list': 'List',
  'page.title.edit': 'Edit',
  'page.title.create': 'Create',
  'page.title.delete': 'Delete',
  'page.options.status.enabled': 'Enabled',
  'page.options.status.disabled': 'Disabled',
  'page.options.status.locked': 'Locked',
  'page.title.password.reset': 'ResetPassword',
  ...
  'page.message.edit.success': 'Update successfully!',
  'page.column.role.title': 'Role',
  'page.column.avatar.title': 'Avatar',
  'page.column.username.title': 'Username',
  'page.column.password.title': 'Password',
  'page.column.password.confirm.title': 'Confirm Password',
  'page.column.email.title': 'Email',
  'page.column.phone.title': 'Phone',
  'page.column.status.title': 'Status',
  'page.column.created.at.title': 'Created Time',
  'page.column.updated.at.title': 'Updated Time',
  'page.column.name.title': 'Name',
  'page.message.username.rule.pattern':
